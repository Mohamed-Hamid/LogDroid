...
public class SoftKeyboard extends InputMethodService 
    ...
    private String foregroundTaskAppName = null;
    private String compulativeText = null;
    ...
    @Override public void onInitializeInterface() {
        ...
        Log.d("HI THERE","onInitializeInterface");
    }
    ...
    @Override public View onCreateInputView() {
        ...
        Log.d("HI THERE","onCreateInputView");
        return mInputView;
    }
    ...
    @Override public View onCreateCandidatesView() {
        ...
        Log.d("HI THERE","onCreateCandidatesView");
    ...
    @Override public void onStartInput(EditorInfo attribute, boolean restarting) {
        ...
        /*int variation_ = attribute.inputType & InputType.TYPE_MASK_VARIATION;
        if (variation_ == InputType.TYPE_NUMBER_VARIATION_PASSWORD){
        ...
        switch (attribute.inputType & InputType.TYPE_MASK_CLASS) {
            ...
            case InputType.TYPE_CLASS_TEXT:
                ...
                if ((attribute.inputType & InputType.TYPE_TEXT_FLAG_AUTO_COMPLETE) != 0) {
                    ...
                    // to supply theirown.  We only show the editor's
    ...
    @Override public void onStartInputView(EditorInfo attribute, boolean restarting) {
        ...
        Log.d("HI THERE","onStartInputView");
        ...
        try {
            ...
            Log.w("YES", "App name = " + foregroundTaskAppName);
    ...
    @Override public void onDisplayCompletions(CompletionInfo[] completions) {
        if (mCompletionOn) {
            ...
            Log.d("HI THERE","onDisplayCompletions");
    ...
    public void onFinishCandidatesView(boolean finishingInput) {
        Log.w("HI THERE", "onFinishCandidateView");
